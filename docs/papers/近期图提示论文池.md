...
- Primary local sources:
  - `D:\GPL\gpl-survey\papers\zotero\pdfs`
  - `D:\GPL\gpl-survey\papers\section5-candidates`
  - `tex/zotero.bib`
- Verification used in this task:
  - retained-paper keys were checked against `tex/zotero.bib`
  - local PDF availability was checked against the two local PDF directories above
...
## Local PDF availability check

- Verified retained-paper count: `19`
- Retained papers with matching local PDF found: `18`
- Retained papers without matching local PDF found in the current local corpus: `1`
  - `xu2025dpgpl` (`2503.10544`)

All 19 retained papers already have matching entries in `tex/zotero.bib`. In other words, Task 2 did not require adding new BibTeX entries this round; the required entries were already present in the local bibliography.
...
- local PDF and bibliography verification completed for retained items
- preliminary dispositions assigned
- retained papers confirmed in `tex/zotero.bib`
