...
| One Prompt Fits All (UniPrompt)                      | arXiv 2025                       | Medium    | Maybe later   | Conceptually strong and directly relevant to universal adaptation, but still a preprint. Track for future updates. |
...
| One Prompt Fits All                                          | 2025 | arXiv only                   | Medium    | Maybe later   | Promising universal adaptation method, but preprint-only.    |
